...
You can simply apply the [Antrea IPsec deployment yaml](https://github.com/antrea-io/antrea/blob/v1.15.2/build/yamls/antrea-ipsec.yml)
...
First, download the [Antrea deployment yaml](https://github.com/antrea-io/antrea/blob/v1.15.2/build/yamls/antrea.yml). To deploy
