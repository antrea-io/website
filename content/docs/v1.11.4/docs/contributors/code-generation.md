...
If you make any change to [cni.proto](https://github.com/antrea-io/antrea/blob/v1.11.4/pkg/apis/cni/v1beta1/cni.proto), you can
...
[update-codegen-dockerized.sh](https://github.com/antrea-io/antrea/blob/v1.11.4/hack/update-codegen-dockerized.sh) accordingly. All the mocks for a
...
To regenerate the metrics list within the document, use [make-metrics-doc.sh](https://github.com/antrea-io/antrea/blob/v1.11.4/hack/make-metrics-doc.sh)
