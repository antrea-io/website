...
Agent in the [Antrea deployment yaml](https://github.com/antrea-io/antrea/blob/v2.3.0/build/yamls/antrea.yml).
For example:
...
[Antrea deployment yaml](https://github.com/antrea-io/antrea/blob/v2.3.0/build/yamls/antrea.yml).
