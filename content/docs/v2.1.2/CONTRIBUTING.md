...
2. Format your code with `make golangci-fix`; if the [linters](https://github.com/antrea-io/antrea/blob/v2.1.2/ci/README.md) flag an issue that
...
cases to our [automated test suite](https://github.com/antrea-io/antrea/blob/v2.1.2/ci/README.md) to guarantee enough
...
[ci/README.md](https://github.com/antrea-io/antrea/blob/v2.1.2/ci/README.md).
