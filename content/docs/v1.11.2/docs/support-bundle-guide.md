...
[RBAC file](https://github.com/antrea-io/antrea/blob/v1.11.2/build/yamls/externalnode/support-bundle-collection-rbac.yml).
...
CR, please refer to the [CRD definition](https://github.com/antrea-io/antrea/blob/v1.11.2/build/charts/antrea/crds/supportbundlecollection.yaml)
