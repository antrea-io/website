...
CRDs should already be added. If not, please refer to [antrea.yaml](https://github.com/antrea-io/antrea/blob/v1.11.2/build/yamls/antrea.yml) to
...
You can update [antrea-octant.yaml](https://github.com/antrea-io/antrea/blob/v1.11.2/build/yamls/antrea-octant.yml) according to
...
2. You can change the sample yaml [build/yamls/antrea-octant.yml](https://github.com/antrea-io/antrea/blob/v1.11.2/build/yamls/antrea-octant.yml)
