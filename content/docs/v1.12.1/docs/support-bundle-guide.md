...
[RBAC file](https://github.com/antrea-io/antrea/blob/v1.12.1/build/yamls/externalnode/support-bundle-collection-rbac.yml).
...
CR, please refer to the [CRD definition](https://github.com/antrea-io/antrea/blob/v1.12.1/build/charts/antrea/crds/supportbundlecollection.yaml)
