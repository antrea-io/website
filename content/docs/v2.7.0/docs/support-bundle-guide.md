...
[RBAC file](https://github.com/antrea-io/antrea/blob/v2.7.0/build/yamls/externalnode/support-bundle-collection-rbac.yml).
...
CR, please refer to the [CRD definition](https://github.com/antrea-io/antrea/blob/v2.7.0/build/charts/antrea/crds/supportbundlecollection.yaml)
...
| IP Route All Tables Info (Linux Only) | `agent`, `outside`, `Node`, `ExternalNode`               | Output of `ip route show table all` on Linux (includes per-Egress custom routing tables)                                                                                                                                                                                  |
| IP Rule Info (Linux Only)             | `agent`, `outside`, `Node`, `ExternalNode`               | Output of `ip rule` on Linux (policy routing rules managed by Antrea for Egress)                                                                                                                                                                                          |
