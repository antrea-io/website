...
[![Go Report Card](https://goreportcard.com/badge/antrea.io/antrea/v2)](https://goreportcard.com/report/antrea.io/antrea/v2)
...
the [Changelogs](https://github.com/antrea-io/antrea/blob/v2.7.0/CHANGELOG/README.md) for a detailed list of features
...
Antrea is licensed under the [Apache License, version 2.0](https://github.com/antrea-io/antrea/blob/v2.7.0/LICENSE)
