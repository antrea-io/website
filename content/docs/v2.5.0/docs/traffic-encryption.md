...
You can simply apply the [Antrea IPsec deployment yaml](https://github.com/antrea-io/antrea/blob/v2.5.0/build/yamls/antrea-ipsec.yml)
...
First, download the [Antrea deployment yaml](https://github.com/antrea-io/antrea/blob/v2.5.0/build/yamls/antrea.yml). To deploy
