...
`antrea-agent` as a command-line argument. Refer to the [sample configuration](https://github.com/antrea-io/antrea/blob/v1.14.1/build/yamls/externalnode/conf/antrea-agent.conf)
...
[antrea-agent.conf](https://github.com/antrea-io/antrea/blob/v1.14.1/build/yamls/externalnode/conf/antrea-agent.conf).
...
3. Create a ServiceAccount, ClusterRole and ClusterRoleBinding for `antrea-agent`
   ...
   the [VM RBAC manifest](https://github.com/antrea-io/antrea/blob/v1.14.1/build/yamls/externalnode/vm-agent-rbac.yml) and
...
2. Copy configuration files to the VM, including [antrea-agent.conf](https://github.com/antrea-io/antrea/blob/v1.14.1/build/yamls/externalnode/conf/antrea-agent.conf),
...
3. Bootstrap `antrea-agent` using one of these 2 methods:
   ...
   1. Bootstrap `antrea-agent` using the [installation script](https://github.com/antrea-io/antrea/blob/v1.14.1/hack/externalnode/install-vm.sh)
...
1. `Docker` is used as the container runtime for Linux VMs. The Docker image can be built from source code
   ...
   2. Docker Repository
      ...
      The [installation script](https://github.com/antrea-io/antrea/blob/v1.14.1/hack/externalnode/install-vm.sh) automatically downloads the specific released
...
3. Bootstrap `antrea-agent` using the [installation script](https://github.com/antrea-io/antrea/blob/v1.14.1/hack/externalnode/install-vm.sh)
...
2. Copy [antrea-agent.conf](https://github.com/antrea-io/antrea/blob/v1.14.1/build/yamls/externalnode/conf/antrea-agent.conf),
...
3. Bootstrap `antrea-agent` using one of these 2 methods:
   ...
   1. Bootstrap `antrea-agent` using the [installation script](https://github.com/antrea-io/antrea/blob/v1.14.1/hack/externalnode/install-vm.ps1)
...
For more details please refer to [vm-agent-rbac.yml](https://github.com/antrea-io/antrea/blob/v1.14.1/build/yamls/externalnode/vm-agent-rbac.yml)
