...
2. Open a PR (labelled with `kind/release`) against the appropriate release
   ...
   - a commit to update the [CHANGELOG](https://github.com/antrea-io/antrea/blob/v2.4.2/CHANGELOG). *For a minor release*,
     ...
     [prepare-changelog.sh](https://github.com/antrea-io/antrea/blob/v2.4.2/hack/release/prepare-changelog.sh) script may
     be used to easily generate links to PRs and the Github profiles of PR
     authors. Use `prepare-changelog.sh -h` to get the usage.
   - a commit to update [VERSION](https://github.com/antrea-io/antrea/blob/v2.4.2/VERSION) as needed, using the following
...
5. Make the release on Github **with the release branch as the target** and copy
   ...
   [draft-release.sh](https://github.com/antrea-io/antrea/blob/v2.4.2/hack/release/draft-release.sh) script can
...
8. *For a minor release* Finally, open a PR against the main branch with a
   single commit, to update [VERSION](https://github.com/antrea-io/antrea/blob/v2.4.2/VERSION) to the next minor version
