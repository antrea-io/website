...
this [base configuration file](https://github.com/antrea-io/antrea/blob/v2.4.2/build/charts/antrea/conf/antrea-agent.conf).
For all the configuration parameters of a Windows Node, refer to this [base
configuration file](https://github.com/antrea-io/antrea/blob/v2.4.2/build/charts/antrea-windows/conf/antrea-agent.conf).
...
refer to this [base configuration file](https://github.com/antrea-io/antrea/blob/v2.4.2/build/charts/antrea/conf/antrea-controller.conf).
