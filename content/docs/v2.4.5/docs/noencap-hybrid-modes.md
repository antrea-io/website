...
Agent in the [Antrea deployment yaml](https://github.com/antrea-io/antrea/blob/v2.4.5/build/yamls/antrea.yml).
For example:
...
[Antrea deployment yaml](https://github.com/antrea-io/antrea/blob/v2.4.5/build/yamls/antrea.yml).
