...
the [Changelogs](https://github.com/antrea-io/antrea/blob/v2.4.5/CHANGELOG/README.md) for a detailed list of features
...
Antrea is licensed under the [Apache License, version 2.0](https://github.com/antrea-io/antrea/blob/v2.4.5/LICENSE)
